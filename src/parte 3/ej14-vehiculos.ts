...
export class Auto extends Vehiculo {
    acelerar(): void {
        console.log(`El auto ${this.marca} ${this.modelo} esta acelerando`);
    }
}

export class Moto extends Vehiculo {
    acelerar(): void {
        console.log(`La moto ${this.marca} ${this.modelo} esta acelerando`);
    }
}

export class Camion extends Vehiculo {
    acelerar(): void {
        console.log(`EL camion ${this.marca} ${this.modelo} esta acelerando`);
    }
}
